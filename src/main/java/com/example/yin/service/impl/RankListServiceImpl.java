...
public class RankListServiceImpl extends ServiceImpl<RankListMapper, RankList> implements RankListService {
    ...
    public R rankOfSongListId(Long songListId) {
        ...
        Long rankNum = baseMapper.selectCount(queryWrapper);
        double avgScore = (rankNum <= 0) ? 0.0 : (double) rankMapper.selectScoreSum(songListId) / rankNum;
        return R.success(null, avgScore);
    }
